/**
 * 包入口：三个正式函数、一个状态常量对象，以及**调用方会持有或接收的 7 个类型**。
 *
...
export { ErrorOrigin } from './public-types.ts'
export type {
  RefreshDisplay, RefreshError, RefreshHandle, RefreshManager, RefreshOptions, RefreshSource, SubmitResult,
